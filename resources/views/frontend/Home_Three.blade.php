...
@section('content')
                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="banner-content"> 
                            <h2 class="title">Build Skills With Experts Any Time Anywhere</h2>
                            <p class="desc">Professor is Best & Perfect Venue to Grow up Your Knowledge</p>
                        ...
                        <div class="feature-item">
                            <div class="feature-inner">
                                ...
                                <div class="feature-content">
                                    <a href="#"><h5>Book & Library <span>Facelities</span></h5></a>
                    ...
                    <div class="col">
                        <div class="feature-item">
                            <div class="feature-inner">
                                ...
                                <div class="feature-content">
                                    <a href="#"><h5>Online & Offline <span>Courses</span></h5></a>
                                    <a href="#" class="lab-btn-text">View More <span></span></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col">
                        <div class="feature-item">
                            <div class="feature-inner">
                                ...
                                <div class="feature-content">
                                    <a href="#"><h5>Certification After  <span>Course Complete</span></h5></a>
                                    <a href="#" class="lab-btn-text">View More <span></span></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col">
                        <div class="feature-item">
                            <div class="feature-inner">
                                ...
                                <div class="feature-content">
                                    <a href="#"><h5>Professional and  <span>Ingenious Instructor</span></h5></a>
                                    <a href="#" class="lab-btn-text">View More <span></span></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col">
                        <div class="feature-item">
                            <div class="feature-inner">
                                ...
                                <div class="feature-content">
                                    <a href="#"><h5>Air Condition Class <span>Room</span></h5></a>
                                    <a href="#" class="lab-btn-text">View More <span></span></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col">
                        <div class="feature-item">
                            <div class="feature-inner">
                                ...
                                <div class="feature-content">
                                    <a href="#"><h5>Best Industry <span>Leader</span></h5></a>
                                    <a href="#" class="lab-btn-text">View More <span></span></a>
                                </div>
                            </div>
                        </div>
    ...
    <div class="course-section style-2 padding-tb">
        <div class="container">
            <div class="section-header">
                <span class="subtitle">Don’t Miss</span>
                            ...
                            <div class="course-item style-3">
                                <div class="course-inner text-center">
                                    ...
                                    <div class="course-content">
                                        <a href="course-single.html"><h4>Learn Basic Web Design with HTML & CSS</h4></a>
                            ...
                            <div class="count-item">
                                <div class="count-inner">
                                    ...
                                    <div class="count-content">
                                        <h2><span class="count" data-to="12600" data-speed="1500"></span><span>+</span></h2>
                        ...
                        <div class="col">
                            <div class="count-item">
                                <div class="count-inner">
                                    ...
                                    <div class="count-content">
                                        <h2><span class="count" data-to="50" data-speed="1500"></span><span>+</span></h2>
    ...
    <div class="event-section padding-tb">
        <div class="container">
            <div class="section-header text-center">
                ...
                <p class="desc">Take courses on your any device with our app & learn all time what you want. Just download & install & start to learn</p>
            </div>
            <div class="section-wrapper">
                                ...
                                <div class="event-inner">
                                    ...
                                    <div class="event-content">
                                        ...
                                        <div class="event-content-info">
                                            <a href="#"><h4>The Way of Higher Education & Its Difficulties</h4></a>
                                            <ul class="lab-ul">
                                                <li><i class="icofont-clock-time"></i> 08:30 am</li>
                                                <li><i class="icofont-google-map"></i> National Auditorium, Dhaka</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="event-item">
                                <div class="event-inner">
                                    <div class="event-content">
                                        ...
                                        <div class="event-content-info">
                                            <a href="#"><h5>Convocation and Celebration 2021</h5></a>
                                            <ul class="lab-ul">
                                                <li><i class="icofont-clock-time"></i> 08:30 am</li>
                                                <li><i class="icofont-google-map"></i> National Auditorium, Dhaka</li>
                                            </ul>
            ...
            <div class="row row-cols-xl-2 row-cols-1">
                <div class="col">
                    <div class="section-header">
                        ...
                        <h2 class="title fw-normal text-white">Join on Day Long Free Workshop for <span class="fw-bold">Advance</span> <span class="theme-color fw-bold">PHP</span> <span class="fw-bold">Language</span></h2>
                    </div>
                    <div class="section-wrapper">
                        <div class="workshop-date">
                            <ul class="lab-ul date" data-date="november 09, 2021 18:25:25">
                                <li>
                                    <h2 class="count-title days">00</h2>
                                    <p class="days_text">Day</p>
                                </li>
                                <li>
                                    <h2 class="count-title"><span class="hours">00</span></h2>
                                    <p class="hours_text">Hour</p>
                                </li>
                                <li>
                                    <h2 class="count-title"><span class="minutes">00</span></h2>
                                    <p class="minu_text">Minute</p>
                                </li>
                                <li>
                                    <h2 class="count-title"><span class="seconds">00</span></h2>
        ...
        <div class="container">
            <div class="section-wrapper">
                <div class="workshop-title">
                    <h5>Just Create Your Free Account Now & Join the Workshop</h5>
                </div>
                <div class="workshop-join-form">
                    <form>
                        ...
                        <div class="submit-area">
                            <button type="submit" class="lab-btn"><span>Join Now</span></button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <div class="clients-section padding-tb">
        <div class="container">
            <div class="section-header text-center">
                <span class="subtitle">Don’t Miss the Day</span>
                <h2 class="title">The People Says About Us</h2>
            </div>
            <div class="section-wrapper">
