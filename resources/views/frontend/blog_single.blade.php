                                    ...
                                    <div class="post-item style-2">
                                        <div class="post-inner">
                                            <div class="post-thumb">
                                                <img src="assets/images/blog/single/01.jpg" alt="blog thumb rajibraj91" class="w-100">
                                            </div>
                                            <div class="post-content">
                                                <h2>Interactively Morph High Standards Anding</h2>
                                                <div class="meta-post">
                                                    <ul class="lab-ul">
                                                        <li><a href="#"><i class="icofont-calendar"></i>April 23,2021</a></li>
                                                        <li><a href="#"><i class="icofont-ui-user"></i>Rajib Raj</a></li>
